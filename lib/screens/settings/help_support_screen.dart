      ...
      'items': [
        ...
        },
        {
          ...
          'answer':
              ...
              'お手数をおかけしますが、下記のお問い合わせ窓口より、登録済みのIDと変更後のメールアドレスを添えてご連絡ください。',
        },
        {
          'question': '退会するとデータはどうなりますか？',
          'answer':
              'マイページの「退会する」から手続きいただくと、プロフィール・写真・提出済みの本人確認書類を含むご自身のデータが完全に削除され、復元することはできません。'
              'なお、お相手とのトーク履歴については、相手側の会話記録を保護する目的で、相手のトーク画面には引き続き表示される場合があります。'
    ...
    },
    {
      ...
      'items': [
        ...
        },
        {
          ...
          'answer':
              '名前・年齢・プロフィール写真・「好きなこと（趣味）」のいずれかが未入力のプロフィールは、検索結果や一覧画面には表示されない仕様になっています。'
      ...
      'items': [
        ...
        },
        {
          ...
          'answer':
              ...
              '該当のユーザーは速やかに通報・ブロックのうえ、下記のお問い合わせ窓口までスクリーンショットを添えてご連絡ください。'
      ...
      'items': [
        ...
        },
        {
          ...
          'answer':
              ...
              'アプリの再起動後もプランが反映されない場合は、購入日時・購入した端末の種類（iOS / Android）を添えて、下記のお問い合わせ窓口までご連絡ください。',
        },
      ],
    },
  ];
